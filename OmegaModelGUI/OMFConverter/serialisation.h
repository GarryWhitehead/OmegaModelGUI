...
public:
	...
	// omf model unique serialization functions
	void Serialise(OMFConverter::Material& material, const Archiver::var_info& info);
	void Serialise(OMFConverter::FaceInfo& face, const Archiver::var_info& info);
	void Serialise(OMFConverter::Mesh& mesh, const Archiver::var_info& info);
	void Serialise(OMFConverter::ModelInfo& model, const Archiver::var_info& info);
